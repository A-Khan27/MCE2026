  ...
  useEffect(() => {
    const channel = supabase
      ...
      .on(
        ...
        () => {
          fetchTimeline(); // Refetch when data changes
        }
      )
      .subscribe();
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="text-center py-16">
            <Clock className="w-16 h-16 text-slate-700 mx-auto mb-4 animate-pulse" />
            <p className="text-slate-400 text-lg">Loading timeline...</p>
          </div>
        ) : (
          /* Timeline */
          <div className="relative">
            ...
            <div className="space-y-8">
              {timelineEvents.map((event, index) => {
                ...
                return (
                  <div key={event.id || index} className="relative flex items-start gap-6 sm:gap-8">
                    {/* Dot */}
